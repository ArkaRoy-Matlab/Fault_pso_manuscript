% ***************************************************************
% *** Matlab code for synthetic model (Model 1) of gravity inversion 
...
fprintf('Model 1 having fixed density and with noise\n ')
%Run Model for 10 times and taking best model out of this 10 independent runs
    ...
    save error_energy1_fxd_wo.dat bst_err -Ascii
